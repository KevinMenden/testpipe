...
process STAR_ALIGN {
    ...
    if (workflow.containerEngine == 'singularity' && !params.singularity_pull_docker_container) {
        container "https://depot.galaxyproject.org/singularity/https://depot.galaxyproject.org/singularity/star:2.7.9a--h9ee0642_0"
    } else {
        container "quay.io/biocontainers/quay.io/biocontainers/star:2.7.9a--h9ee0642_0"
    }
